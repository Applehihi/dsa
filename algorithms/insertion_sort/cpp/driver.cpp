...
int main(void) {
    ...
    std::cout<<"Insertion sort on array of 10 elements: \n";
    std::cout<<"Unsorted: ";
    ...
    std::copy(unsorted_array, unsorted_array+10, sorted_array);
    std::cout<<"\nDescending insertion sort on array of 10 elements: \n";
    std::cout<<"Unsorted: ";
    for(auto i: unsorted_array) std::cout<<i<<' ';
    ...
    std::cout<<"\nInsertion sort on std::vector of 10 elements: \n";
    std::cout<<"Unsorted: ";
    ...
    std::cout<<"\nInsertion sort on std::vector of 10 elements with mod 3 comparison: \n";
    std::cout<<"Unsorted: ";
    for(auto i: unsorted_vector) std::cout<<i<<' ';
