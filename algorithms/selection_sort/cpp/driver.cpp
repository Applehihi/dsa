...
int main(void) {
    ...
    std::cout<<"Selection sort on array of 10 elements: \n";
    std::cout<<"Unsorted: ";
    for(auto i: unsorted_array) std::cout<<i<<' ';
    selection_sort<int[10], int>(10, sorted_array);
    std::cout<<"\nSorted: ";
    ...
    std::copy(unsorted_array, unsorted_array+10, sorted_array);
    std::cout<<"\nSelection sort descending on array of 10 elements: \n";
    std::cout<<"Unsorted: ";
    for(auto i: unsorted_array) std::cout<<i<<' ';
    selection_sort<int[10], int>(10, sorted_array, [](int x, int y){ return x<y;});
    std::cout<<"\nSorted: ";
    for(auto i: sorted_array) std::cout<<i<<' ';
    for(int i=0;i<10;i++) {
    ...
    std::cout<<"\nSelection sort on std::vector of 10 elements: \n";
    std::cout<<"Unsorted: ";
    for(auto i: unsorted_vector) std::cout<<i<<' ';
    selection_sort<std::vector<int>, int>(10, sorted_vector);
    std::cout<<"\nSorted: ";
    ...
    std::cout<<"\nSelection sort on std::vector of 10 elements with mod 3 comparison: \n";
    std::cout<<"Unsorted: ";
    for(auto i: unsorted_vector) std::cout<<i<<' ';
    selection_sort<std::vector<int>, int>(10, sorted_vector, [](int x, int y){return x%3>y%3;});
    std::cout<<"\nSorted: ";
    for(auto i: sorted_vector) std::cout<<i<<' ';
